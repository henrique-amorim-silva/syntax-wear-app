    ...
    return(
        <div className="relative">
            <header className="fixed top-10 left-0 right-0 z-10 mx-10">
                <div className='bg-white max-w-330 mx-auto flex justify-between items-center px-7 py-3 rounded-2xl mt-5'>
                    ...
                    <nav>
                        <ul className='flex gap-4 md:gap-10'>
                            <li className='hidden md:block'><a href="#" /> Nossas Lojas</li>
                            <li className='hidden md:block'><a href="#" />Sobre</li>
